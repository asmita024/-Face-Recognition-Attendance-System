    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/palas/OneDrive/Desktop/AMS project/Face-Recognition-Attendance_system-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/palas/OneDrive/Desktop/AMS project/Face-Recognition-Attendance_system-main\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/palas/OneDrive/Desktop/AMS project/Face-Recognition-Attendance_system-main' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/palas/OneDrive/Desktop/AMS project/Face-Recognition-Attendance_system-main\Attendance\-------Check atttendance-------"')
...
def admin_panel():
    ...
    def show_student_details():
        ...
        cs = 'C:/Users/palas/OneDrive/Desktop/AMS project/Face-Recognition-Attendance_system-main/StudentDetails/StudentDetails.csv'
        with open(cs, newline="") as file:
            reader = csv.reader(file)
            r = 0
